...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType2_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType2, mbsfn_SubframeConfigList_v14xy),
		(ASN_TAG_CLASS_CONTEXT | (22 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_MBSFN_SubframeConfigList_v14xy,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType2_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (22 << 2)), 22, 0, 0 }, /* mbsfn-SubframeConfigList-v14xy */
