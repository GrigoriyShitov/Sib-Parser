...
asn_TYPE_member_t asn_MBR_SL_CommResourcePoolV2X_r14_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct SL_CommResourcePoolV2X_r14, cbr_MeasConfig_r14),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SL_CBR_MeasConfig_r14,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"cbr-MeasConfig-r14"
	...
	{ ATF_POINTER, 4, offsetof(struct SL_CommResourcePoolV2X_r14, cbr_pssch_TxConfigList_r14),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_SL_CBR_PSSCH_TxConfigList_r14,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_SL_CommResourcePoolV2X_r14_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 }, /* cbr-MeasConfig-r14 */
