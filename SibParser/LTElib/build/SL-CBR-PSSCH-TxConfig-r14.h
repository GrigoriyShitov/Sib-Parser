...
struct SL_PPPP_PSSCH_TxConfig_r14;

/* SL-CBR-PSSCH-TxConfig-r14 */
typedef struct SL_CBR_PSSCH_TxConfig_r14 {
	SL_CBR_Range_r14_t	 cbr_Range_r14;
	struct SL_CBR_PSSCH_TxConfig_r14__tx_Parameters_ListPPPP_r14 {
		A_SEQUENCE_OF(struct SL_PPPP_PSSCH_TxConfig_r14) list;
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} tx_Parameters_ListPPPP_r14;
