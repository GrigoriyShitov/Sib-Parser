...
static int
memb_power_r14_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_power_r14_constr_3 CC_NOTUSED = {
	{ 1, 0 }	/* (-126..31) */,
	-1};
static asn_per_constraints_t asn_PER_memb_power_r14_constr_3 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_SL_TxPower_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_TxPower_r14, choice.power_r14),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_power_r14_constr_3, &asn_PER_memb_power_r14_constr_3,  memb_power_r14_constraint_1 },
		0, 0, /* No default value */
		"power-r14"
		},
};
static const asn_TYPE_tag2member_t asn_MAP_SL_TxPower_r14_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* power-r14 */
};
