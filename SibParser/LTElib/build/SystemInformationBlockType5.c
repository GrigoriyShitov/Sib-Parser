...
static asn_oer_constraints_t asn_OER_memb_scptm_FreqOffset_r14_constr_12 CC_NOTUSED = {
	{ 1, 1 }	/* (1..8) */,
	-1};
static asn_per_constraints_t asn_PER_memb_scptm_FreqOffset_r14_constr_12 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType5_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct SystemInformationBlockType5, interFreqCarrierFreqList_v1250),
	...
	{ ATF_POINTER, 7, offsetof(struct SystemInformationBlockType5, interFreqCarrierFreqListExt_r12),
	...
	{ ATF_POINTER, 6, offsetof(struct SystemInformationBlockType5, interFreqCarrierFreqListExt_v1280),
	...
	{ ATF_POINTER, 5, offsetof(struct SystemInformationBlockType5, interFreqCarrierFreqList_v1310),
	...
	{ ATF_POINTER, 4, offsetof(struct SystemInformationBlockType5, interFreqCarrierFreqListExt_v1310),
	...
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType5, interFreqCarrierFreqList_v1350),
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType5, interFreqCarrierFreqListExt_v1350),
	...
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType5, scptm_FreqOffset_r14),
		...
		0,
		{ &asn_OER_memb_scptm_FreqOffset_r14_constr_12, &asn_PER_memb_scptm_FreqOffset_r14_constr_12,  memb_scptm_FreqOffset_r14_constraint_1 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType5_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (9 << 2)), 9, 0, 0 } /* scptm-FreqOffset-r14 */
};
