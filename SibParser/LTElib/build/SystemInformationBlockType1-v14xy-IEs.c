...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtension_specs_5 = {
	sizeof(struct SystemInformationBlockType1_v14xy_IEs__nonCriticalExtension),
	offsetof(struct SystemInformationBlockType1_v14xy_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_member_t asn_MBR_SystemInformationBlockType1_v14xy_IEs_1[] = {
	{ ATF_POINTER, 3, offsetof(struct SystemInformationBlockType1_v14xy_IEs, eCallOverIMS_Support_r14),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 2, offsetof(struct SystemInformationBlockType1_v14xy_IEs, tdd_Config_v14xy),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_TDD_Config_v14xy,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"tdd-Config-v14xy"
		},
	{ ATF_POINTER, 1, offsetof(struct SystemInformationBlockType1_v14xy_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
...
static const int asn_MAP_SystemInformationBlockType1_v14xy_IEs_oms_1[] = { 0, 1, 2 };
static const ber_tlv_tag_t asn_DEF_SystemInformationBlockType1_v14xy_IEs_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SystemInformationBlockType1_v14xy_IEs_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eCallOverIMS-Support-r14 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* tdd-Config-v14xy */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* nonCriticalExtension */
};
asn_SEQUENCE_specifics_t asn_SPC_SystemInformationBlockType1_v14xy_IEs_specs_1 = {
	sizeof(struct SystemInformationBlockType1_v14xy_IEs),
	offsetof(struct SystemInformationBlockType1_v14xy_IEs, _asn_ctx),
	asn_MAP_SystemInformationBlockType1_v14xy_IEs_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_SystemInformationBlockType1_v14xy_IEs_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_SystemInformationBlockType1_v14xy_IEs = {
	"SystemInformationBlockType1-v14xy-IEs",
	"SystemInformationBlockType1-v14xy-IEs",
	&asn_OP_SEQUENCE,
	asn_DEF_SystemInformationBlockType1_v14xy_IEs_tags_1,
	sizeof(asn_DEF_SystemInformationBlockType1_v14xy_IEs_tags_1)
		/sizeof(asn_DEF_SystemInformationBlockType1_v14xy_IEs_tags_1[0]), /* 1 */
	asn_DEF_SystemInformationBlockType1_v14xy_IEs_tags_1,	/* Same as above */
	sizeof(asn_DEF_SystemInformationBlockType1_v14xy_IEs_tags_1)
		/sizeof(asn_DEF_SystemInformationBlockType1_v14xy_IEs_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_SystemInformationBlockType1_v14xy_IEs_1,
	3,	/* Elements count */
	&asn_SPC_SystemInformationBlockType1_v14xy_IEs_specs_1	/* Additional specs */
};
