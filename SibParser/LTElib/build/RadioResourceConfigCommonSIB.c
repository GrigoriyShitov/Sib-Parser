...
asn_TYPE_member_t asn_MBR_RadioResourceConfigCommonSIB_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigCommonSIB, prach_Config_v14xy),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigCommonSIB, pucch_ConfigCommon_v14xy),
...
static const asn_TYPE_tag2member_t asn_MAP_RadioResourceConfigCommonSIB_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (21 << 2)), 21, 0, 0 }, /* prach-Config-v14xy */
    { (ASN_TAG_CLASS_CONTEXT | (22 << 2)), 22, 0, 0 } /* pucch-ConfigCommon-v14xy */
};
