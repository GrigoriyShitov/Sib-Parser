...
static asn_oer_constraints_t asn_OER_type_mcch_RepetitionPeriod_v14xy_constr_24 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_mcch_RepetitionPeriod_v14xy_constr_24 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_mcch_ModificationPeriod_v14xy_constr_33 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_mcch_ModificationPeriod_v14xy_constr_33 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  15 }	/* (0..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_type_subcarrierSpacingMBMS_r14_constr_50 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_subcarrierSpacingMBMS_r14_constr_50 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_mcch_RepetitionPeriod_v14xy_value2enum_24[] = {
	{ 0,	3,	"rf1" },
	{ 1,	3,	"rf2" },
	{ 2,	3,	"rf4" },
	{ 3,	3,	"rf8" },
...
static const unsigned int asn_MAP_mcch_RepetitionPeriod_v14xy_enum2value_24[] = {
	0,	/* rf1(0) */
	4,	/* rf16(4) */
	1,	/* rf2(1) */
	2,	/* rf4(2) */
...
static const asn_INTEGER_specifics_t asn_SPC_mcch_RepetitionPeriod_v14xy_specs_24 = {
	asn_MAP_mcch_RepetitionPeriod_v14xy_value2enum_24,	/* "tag" => N; sorted by tag */
	asn_MAP_mcch_RepetitionPeriod_v14xy_enum2value_24,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_mcch_RepetitionPeriod_v14xy_tags_24[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_mcch_RepetitionPeriod_v14xy_24 = {
	"mcch-RepetitionPeriod-v14xy",
	"mcch-RepetitionPeriod-v14xy",
	&asn_OP_NativeEnumerated,
	asn_DEF_mcch_RepetitionPeriod_v14xy_tags_24,
	sizeof(asn_DEF_mcch_RepetitionPeriod_v14xy_tags_24)
		/sizeof(asn_DEF_mcch_RepetitionPeriod_v14xy_tags_24[0]) - 1, /* 1 */
	asn_DEF_mcch_RepetitionPeriod_v14xy_tags_24,	/* Same as above */
	sizeof(asn_DEF_mcch_RepetitionPeriod_v14xy_tags_24)
		/sizeof(asn_DEF_mcch_RepetitionPeriod_v14xy_tags_24[0]), /* 2 */
	{ &asn_OER_type_mcch_RepetitionPeriod_v14xy_constr_24, &asn_PER_type_mcch_RepetitionPeriod_v14xy_constr_24, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_mcch_RepetitionPeriod_v14xy_specs_24	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_mcch_ModificationPeriod_v14xy_value2enum_33[] = {
	{ 0,	3,	"rf1" },
	{ 1,	3,	"rf2" },
	{ 2,	3,	"rf4" },
	{ 3,	3,	"rf8" },
...
static const unsigned int asn_MAP_mcch_ModificationPeriod_v14xy_enum2value_33[] = {
	0,	/* rf1(0) */
	7,	/* rf128(7) */
	4,	/* rf16(4) */
	1,	/* rf2(1) */
...
static const asn_INTEGER_specifics_t asn_SPC_mcch_ModificationPeriod_v14xy_specs_33 = {
	asn_MAP_mcch_ModificationPeriod_v14xy_value2enum_33,	/* "tag" => N; sorted by tag */
	asn_MAP_mcch_ModificationPeriod_v14xy_enum2value_33,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_mcch_ModificationPeriod_v14xy_tags_33[] = {
	(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_mcch_ModificationPeriod_v14xy_33 = {
	"mcch-ModificationPeriod-v14xy",
	"mcch-ModificationPeriod-v14xy",
	&asn_OP_NativeEnumerated,
	asn_DEF_mcch_ModificationPeriod_v14xy_tags_33,
	sizeof(asn_DEF_mcch_ModificationPeriod_v14xy_tags_33)
		/sizeof(asn_DEF_mcch_ModificationPeriod_v14xy_tags_33[0]) - 1, /* 1 */
	asn_DEF_mcch_ModificationPeriod_v14xy_tags_33,	/* Same as above */
	sizeof(asn_DEF_mcch_ModificationPeriod_v14xy_tags_33)
		/sizeof(asn_DEF_mcch_ModificationPeriod_v14xy_tags_33[0]), /* 2 */
	{ &asn_OER_type_mcch_ModificationPeriod_v14xy_constr_33, &asn_PER_type_mcch_ModificationPeriod_v14xy_constr_33, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_mcch_ModificationPeriod_v14xy_specs_33	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_subcarrierSpacingMBMS_r14_value2enum_50[] = {
	{ 0,	9,	"khz-7dot5" },
	{ 1,	10,	"khz-1dot25" }
};
static const unsigned int asn_MAP_subcarrierSpacingMBMS_r14_enum2value_50[] = {
	1,	/* khz-1dot25(1) */
	0	/* khz-7dot5(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_subcarrierSpacingMBMS_r14_specs_50 = {
	asn_MAP_subcarrierSpacingMBMS_r14_value2enum_50,	/* "tag" => N; sorted by tag */
	asn_MAP_subcarrierSpacingMBMS_r14_enum2value_50,	/* N => "tag"; sorted by N */
	2,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_subcarrierSpacingMBMS_r14_tags_50[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_subcarrierSpacingMBMS_r14_50 = {
	"subcarrierSpacingMBMS-r14",
	"subcarrierSpacingMBMS-r14",
	&asn_OP_NativeEnumerated,
	asn_DEF_subcarrierSpacingMBMS_r14_tags_50,
	sizeof(asn_DEF_subcarrierSpacingMBMS_r14_tags_50)
		/sizeof(asn_DEF_subcarrierSpacingMBMS_r14_tags_50[0]) - 1, /* 1 */
	asn_DEF_subcarrierSpacingMBMS_r14_tags_50,	/* Same as above */
	sizeof(asn_DEF_subcarrierSpacingMBMS_r14_tags_50)
		/sizeof(asn_DEF_subcarrierSpacingMBMS_r14_tags_50[0]), /* 2 */
	{ &asn_OER_type_subcarrierSpacingMBMS_r14_constr_50, &asn_PER_type_subcarrierSpacingMBMS_r14_constr_50, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_subcarrierSpacingMBMS_r14_specs_50	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_MBSFN_AreaInfo_r9_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct MBSFN_AreaInfo_r9, mcch_RepetitionPeriod_v14xy),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_mcch_RepetitionPeriod_v14xy_24,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"mcch-RepetitionPeriod-v14xy"
		},
	{ ATF_POINTER, 2, offsetof(struct MBSFN_AreaInfo_r9, mcch_ModificationPeriod_v14xy),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_mcch_ModificationPeriod_v14xy_33,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"mcch-ModificationPeriod-v14xy"
	...
	{ ATF_POINTER, 1, offsetof(struct MBSFN_AreaInfo_r9, subcarrierSpacingMBMS_r14),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_subcarrierSpacingMBMS_r14_50,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"subcarrierSpacingMBMS-r14"
...
static const int asn_MAP_MBSFN_AreaInfo_r9_oms_1[] = { 4, 5, 6 };
...
static const asn_TYPE_tag2member_t asn_MAP_MBSFN_AreaInfo_r9_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* mcch-RepetitionPeriod-v14xy */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* mcch-ModificationPeriod-v14xy */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* subcarrierSpacingMBMS-r14 */
};
