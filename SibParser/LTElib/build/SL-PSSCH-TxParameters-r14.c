...
static int
memb_minRB_NumberPSSCH_r14_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static int
memb_maxRB_NumberPSSCH_r14_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_minRB_NumberPSSCH_r14_constr_4 CC_NOTUSED = {
	{ 1, 1 }	/* (1..100) */,
	-1};
static asn_per_constraints_t asn_PER_memb_minRB_NumberPSSCH_r14_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  1,  100 }	/* (1..100) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_maxRB_NumberPSSCH_r14_constr_5 CC_NOTUSED = {
	{ 1, 1 }	/* (1..100) */,
	-1};
static asn_per_constraints_t asn_PER_memb_maxRB_NumberPSSCH_r14_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 7,  7,  1,  100 }	/* (1..100) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
asn_TYPE_member_t asn_MBR_SL_PSSCH_TxParameters_r14_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_PSSCH_TxParameters_r14, minRB_NumberPSSCH_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_minRB_NumberPSSCH_r14_constr_4, &asn_PER_memb_minRB_NumberPSSCH_r14_constr_4,  memb_minRB_NumberPSSCH_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SL_PSSCH_TxParameters_r14, maxRB_NumberPSSCH_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_maxRB_NumberPSSCH_r14_constr_5, &asn_PER_memb_maxRB_NumberPSSCH_r14_constr_5,  memb_maxRB_NumberPSSCH_r14_constraint_1 },
		0, 0, /* No default value */
...
static const asn_TYPE_tag2member_t asn_MAP_SL_PSSCH_TxParameters_r14_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* minRB-NumberPSSCH-r14 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* maxRB-NumberPSSCH-r14 */
