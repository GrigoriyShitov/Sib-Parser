...
int main()
{
    ...
    uint8_t packet[] = {0x60, 0xc8, 0x20, 0x21,
                          0x90, 0x40, 0x43, 0x6b,
                          0x5a, 0x00, 0x9c, 0x80,
                          0x70, 0x2e, 0xa1, 0x10,
                          0x80, 0x84, 0x04, 0x21,
                      ...
                      int on_first_pdu)
{
         ...
         (rd = fread(fbuf, 1, fbuf_size, file)) || feof(file) == 0 || (tolerate_eof && DynamicBuffer.length);)
    {
        ...
        {
            /*uint8_t packet[30] = {0x66, 0xea, 0xc1, 0x58, 0xc1, 0x47, 0x58,
             0x07, 0x65, 0x63, 0xa0, 0x1f, 0x15, 0xb5, 0x80, 0x06, 0x9a, 0xa7,
             0xb0, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x02, 0x41, 0x01, 0x11, 0x00,
             0x00}; i_bptr = packet; i_size = 30;*/
