...
static int
memb_eventSpecificParameters_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_eventSpecificParameters_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..2)) */};
static asn_per_constraints_t asn_PER_type_eventSpecificParameters_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 1,  1,  1,  2 }	/* (SIZE(1..2)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_eventSpecificParameters_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..2)) */};
static asn_per_constraints_t asn_PER_memb_eventSpecificParameters_constr_3 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 1,  1,  1,  2 }	/* (SIZE(1..2)) */,
	0, 0	/* No PER value map */
};
...
static const ber_tlv_tag_t asn_DEF_eventSpecificParameters_tags_3[] = {
...
asn_TYPE_descriptor_t asn_DEF_eventSpecificParameters_3 = {
	...
	{ &asn_OER_type_eventSpecificParameters_constr_3, &asn_PER_type_eventSpecificParameters_constr_3, SEQUENCE_OF_constraint },
	asn_MBR_eventSpecificParameters_3,
	1,	/* Single element */
	&asn_SPC_eventSpecificParameters_specs_3	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_TransChCriteria_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct TransChCriteria, eventSpecificParameters),
		...
		0,
		{ &asn_OER_memb_eventSpecificParameters_constr_3, &asn_PER_memb_eventSpecificParameters_constr_3,  memb_eventSpecificParameters_constraint_1 },
		0, 0, /* No default value */
		"eventSpecificParameters"
		},
};
static const int asn_MAP_TransChCriteria_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_TransChCriteria_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_TransChCriteria_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ul-transportChannelID */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* eventSpecificParameters */
};
asn_SEQUENCE_specifics_t asn_SPC_TransChCriteria_specs_1 = {
