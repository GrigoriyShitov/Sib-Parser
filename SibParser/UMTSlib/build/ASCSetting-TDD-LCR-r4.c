...
asn_TYPE_member_t asn_MBR_ASCSetting_TDD_LCR_r4_1[] = {
...
static const int asn_MAP_ASCSetting_TDD_LCR_r4_oms_1[] = { 0 };
static const ber_tlv_tag_t asn_DEF_ASCSetting_TDD_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_ASCSetting_TDD_LCR_r4_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* accessServiceClass-TDD-LCR */
};
asn_SEQUENCE_specifics_t asn_SPC_ASCSetting_TDD_LCR_r4_specs_1 = {
