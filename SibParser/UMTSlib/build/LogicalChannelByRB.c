...
static int
memb_logChOfRb_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_logChOfRb_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..1) */,
	-1};
static asn_per_constraints_t asn_PER_memb_logChOfRb_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_LogicalChannelByRB_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct LogicalChannelByRB, logChOfRb),
		...
		0,
		{ &asn_OER_memb_logChOfRb_constr_3, &asn_PER_memb_logChOfRb_constr_3,  memb_logChOfRb_constraint_1 },
		0, 0, /* No default value */
		"logChOfRb"
		},
};
static const int asn_MAP_LogicalChannelByRB_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_LogicalChannelByRB_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_LogicalChannelByRB_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* rb-Identity */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* logChOfRb */
};
asn_SEQUENCE_specifics_t asn_SPC_LogicalChannelByRB_specs_1 = {
