...
static asn_oer_constraints_t asn_OER_type_PICH_Info_r7_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
asn_per_constraints_t asn_PER_type_PICH_Info_r7_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_fdd_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PICH_Info_r7__fdd, channelisationCode256),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PICH_Info_r7__fdd, pi_CountPerFrame),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PICH_Info_r7__fdd, sttd_Indicator),
...
static asn_SEQUENCE_specifics_t asn_SPC_fdd_specs_2 = {
	sizeof(struct PICH_Info_r7__fdd),
	offsetof(struct PICH_Info_r7__fdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_tdd384_6[] = {
	{ ATF_POINTER, 2, offsetof(struct PICH_Info_r7__tdd384, channelisationCode),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct PICH_Info_r7__tdd384, timeslot),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PICH_Info_r7__tdd384, midambleShiftAndBurstType),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct PICH_Info_r7__tdd384, repetitionPeriodLengthOffset),
	...
	{ ATF_NOFLAGS, 3, offsetof(struct PICH_Info_r7__tdd384, pagingIndicatorLength),
	...
	{ ATF_POINTER, 2, offsetof(struct PICH_Info_r7__tdd384, n_GAP),
	...
	{ ATF_POINTER, 1, offsetof(struct PICH_Info_r7__tdd384, n_PCH),
...
static asn_SEQUENCE_specifics_t asn_SPC_tdd384_specs_6 = {
	sizeof(struct PICH_Info_r7__tdd384),
	offsetof(struct PICH_Info_r7__tdd384, _asn_ctx),
...
static int asn_DFL_20_cmp_1(const void *sptr) {
	const N_GAP_t *st = sptr;
...
static int asn_DFL_20_set_1(void **sptr) {
	N_GAP_t *st = *sptr;
...
static int asn_DFL_21_cmp_2(const void *sptr) {
	const N_PCH_t *st = sptr;
...
static int asn_DFL_21_set_2(void **sptr) {
	N_PCH_t *st = *sptr;
...
static asn_TYPE_member_t asn_MBR_tdd768_14[] = {
	{ ATF_POINTER, 2, offsetof(struct PICH_Info_r7__tdd768, channelisationCode),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct PICH_Info_r7__tdd768, timeslot),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_TimeslotNumber,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PICH_Info_r7__tdd768, midambleShiftAndBurstType),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_MidambleShiftAndBurstType,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct PICH_Info_r7__tdd768, repetitionPeriodLengthOffset),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_RepPerLengthOffset_PICH,
		0,
	...
	{ ATF_NOFLAGS, 3, offsetof(struct PICH_Info_r7__tdd768, pagingIndicatorLength),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PagingIndicatorLength,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct PICH_Info_r7__tdd768, n_GAP),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_N_GAP,
		0,
		{ 0, 0, 0 },
		&asn_DFL_20_cmp_1,	/* Compare DEFAULT 1 */
		&asn_DFL_20_set_1,	/* Set DEFAULT 1 */
		"n-GAP"
		},
	{ ATF_POINTER, 1, offsetof(struct PICH_Info_r7__tdd768, n_PCH),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_N_PCH,
		0,
		{ 0, 0, 0 },
		&asn_DFL_21_cmp_2,	/* Compare DEFAULT 2 */
		&asn_DFL_21_set_2,	/* Set DEFAULT 2 */
		"n-PCH"
		},
};
...
static asn_SEQUENCE_specifics_t asn_SPC_tdd768_specs_14 = {
	sizeof(struct PICH_Info_r7__tdd768),
	offsetof(struct PICH_Info_r7__tdd768, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_PICH_Info_r7_1[] = {
...
asn_CHOICE_specifics_t asn_SPC_PICH_Info_r7_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PICH_Info_r7 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_PICH_Info_r7_constr_1, &asn_PER_type_PICH_Info_r7_constr_1, CHOICE_constraint },
