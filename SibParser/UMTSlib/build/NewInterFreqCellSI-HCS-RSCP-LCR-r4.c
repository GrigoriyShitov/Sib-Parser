...
asn_TYPE_member_t asn_MBR_NewInterFreqCellSI_HCS_RSCP_LCR_r4_1[] = {
...
static const int asn_MAP_NewInterFreqCellSI_HCS_RSCP_LCR_r4_oms_1[] = { 0, 1 };
static const ber_tlv_tag_t asn_DEF_NewInterFreqCellSI_HCS_RSCP_LCR_r4_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NewInterFreqCellSI_HCS_RSCP_LCR_r4_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_NewInterFreqCellSI_HCS_RSCP_LCR_r4_specs_1 = {
