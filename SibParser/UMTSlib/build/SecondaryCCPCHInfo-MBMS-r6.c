...
static const int asn_MAP_fdd_oms_3[] = { 0, 3 };
...
asn_TYPE_member_t asn_MBR_SecondaryCCPCHInfo_MBMS_r6_1[] = {
...
static const ber_tlv_tag_t asn_DEF_SecondaryCCPCHInfo_MBMS_r6_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SecondaryCCPCHInfo_MBMS_r6_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* modeSpecificInfo */
};
asn_SEQUENCE_specifics_t asn_SPC_SecondaryCCPCHInfo_MBMS_r6_specs_1 = {
