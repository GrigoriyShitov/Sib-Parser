...
static asn_TYPE_member_t asn_MBR_fdd_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__fdd, availableSignatures),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__fdd, availableSF),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__fdd, preambleScramblingCodeWordNumber),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__fdd, puncturingLimit),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__fdd, availableSubChannelNumbers),
...
static asn_SEQUENCE_specifics_t asn_SPC_fdd_specs_3 = {
	sizeof(struct PRACH_RACH_Info_r7__modeSpecificInfo__fdd),
	offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__fdd, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_tdd384_9[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd384, timeslot),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd384, channelisationCodeList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd384, prach_Midamble),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_tdd384_specs_9 = {
	sizeof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd384),
	offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd384, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_tdd768_13[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd768, timeslot),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_TimeslotNumber,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd768, channelisationCodeList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd768, prach_Midamble),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_PRACH_Midamble,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_tdd768_specs_13 = {
	sizeof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd768),
	offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo__tdd768, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_modeSpecificInfo_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo, choice.fdd),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_fdd_3,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo, choice.tdd384),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_tdd384_9,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo, choice.tdd768),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_tdd768_13,
		0,
...
static asn_CHOICE_specifics_t asn_SPC_modeSpecificInfo_specs_2 = {
	sizeof(struct PRACH_RACH_Info_r7__modeSpecificInfo),
	offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo, _asn_ctx),
	offsetof(struct PRACH_RACH_Info_r7__modeSpecificInfo, present),
	sizeof(((struct PRACH_RACH_Info_r7__modeSpecificInfo *)0)->present),
...
asn_TYPE_member_t asn_MBR_PRACH_RACH_Info_r7_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_PRACH_RACH_Info_r7_specs_1 = {
