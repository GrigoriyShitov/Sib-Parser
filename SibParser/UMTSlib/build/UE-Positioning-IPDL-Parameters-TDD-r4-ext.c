...
static int
memb_ip_slot_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_ip_Start_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_oer_constraints_t asn_OER_memb_ip_slot_constr_3 CC_NOTUSED = {
	{ 1, 1 }	/* (0..14) */,
	-1};
static asn_per_constraints_t asn_PER_memb_ip_slot_constr_3 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  0,  14 }	/* (0..14) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_ip_Start_constr_4 CC_NOTUSED = {
	{ 2, 1 }	/* (0..4095) */,
	-1};
static asn_per_constraints_t asn_PER_memb_ip_Start_constr_4 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 12,  12,  0,  4095 }	/* (0..4095) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_UE_Positioning_IPDL_Parameters_TDD_r4_ext_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct UE_Positioning_IPDL_Parameters_TDD_r4_ext, ip_slot),
		...
		0,
		{ &asn_OER_memb_ip_slot_constr_3, &asn_PER_memb_ip_slot_constr_3,  memb_ip_slot_constraint_1 },
		0, 0, /* No default value */
		"ip-slot"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct UE_Positioning_IPDL_Parameters_TDD_r4_ext, ip_Start),
		...
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_ip_Start_constr_4, &asn_PER_memb_ip_Start_constr_4,  memb_ip_Start_constraint_1 },
		0, 0, /* No default value */
		"ip-Start"
		},
...
static const int asn_MAP_UE_Positioning_IPDL_Parameters_TDD_r4_ext_oms_1[] = { 3 };
static const ber_tlv_tag_t asn_DEF_UE_Positioning_IPDL_Parameters_TDD_r4_ext_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_Positioning_IPDL_Parameters_TDD_r4_ext_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_IPDL_Parameters_TDD_r4_ext_specs_1 = {
