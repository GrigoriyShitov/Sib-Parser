...
asn_TYPE_member_t asn_MBR_CellSelectReselectInfoSIB_11_12_HCS_ECN0_1[] = {
...
static const int asn_MAP_CellSelectReselectInfoSIB_11_12_HCS_ECN0_oms_1[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_CellSelectReselectInfoSIB_11_12_HCS_ECN0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CellSelectReselectInfoSIB_11_12_HCS_ECN0_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* hcs-NeighbouringCellInformation-ECN0 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* modeSpecificInfo */
};
asn_SEQUENCE_specifics_t asn_SPC_CellSelectReselectInfoSIB_11_12_HCS_ECN0_specs_1 = {
