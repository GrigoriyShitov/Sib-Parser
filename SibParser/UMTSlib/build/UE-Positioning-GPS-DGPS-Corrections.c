...
static int
memb_gps_TOW_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_memb_gps_TOW_constr_2 CC_NOTUSED = {
	{ 4, 1 }	/* (0..604799) */,
	-1};
static asn_per_constraints_t asn_PER_memb_gps_TOW_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 20, -1,  0,  604799 }	/* (0..604799) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_UE_Positioning_GPS_DGPS_Corrections_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct UE_Positioning_GPS_DGPS_Corrections, gps_TOW),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ &asn_OER_memb_gps_TOW_constr_2, &asn_PER_memb_gps_TOW_constr_2,  memb_gps_TOW_constraint_1 },
...
asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_GPS_DGPS_Corrections_specs_1 = {
