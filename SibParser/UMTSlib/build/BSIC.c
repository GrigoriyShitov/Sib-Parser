...
asn_TYPE_member_t asn_MBR_BSIC_1[] = {
...
static const asn_TYPE_tag2member_t asn_MAP_BSIC_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ncc */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* bcc */
};
asn_SEQUENCE_specifics_t asn_SPC_BSIC_specs_1 = {
	sizeof(struct BSIC),
