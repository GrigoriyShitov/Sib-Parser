...
} PDSCH_SysInfoList_SFN_HCR_r5__Member;

/* PDSCH-SysInfoList-SFN-HCR-r5 */
typedef struct PDSCH_SysInfoList_SFN_HCR_r5 {
	A_SEQUENCE_OF(PDSCH_SysInfoList_SFN_HCR_r5__Member) list;
...
extern asn_SET_OF_specifics_t asn_SPC_PDSCH_SysInfoList_SFN_HCR_r5_specs_1;
extern asn_TYPE_member_t asn_MBR_PDSCH_SysInfoList_SFN_HCR_r5_1[1];
extern asn_per_constraints_t asn_PER_type_PDSCH_SysInfoList_SFN_HCR_r5_constr_1;
