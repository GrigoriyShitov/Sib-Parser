...
asn_TYPE_member_t asn_MBR_UE_Positioning_GPS_ReferenceTime_1[] = {
...
static const int asn_MAP_UE_Positioning_GPS_ReferenceTime_oms_1[] = { 2, 3, 4, 5 };
static const ber_tlv_tag_t asn_DEF_UE_Positioning_GPS_ReferenceTime_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_UE_Positioning_GPS_ReferenceTime_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* sfn-tow-Uncertainty */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* utran-GPS-DriftRate */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* gps-TOW-AssistList */
};
asn_SEQUENCE_specifics_t asn_SPC_UE_Positioning_GPS_ReferenceTime_specs_1 = {
