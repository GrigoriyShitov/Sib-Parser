...
asn_TYPE_member_t asn_MBR_CellInfoSI_RSCP_1[] = {
...
static const int asn_MAP_CellInfoSI_RSCP_oms_1[] = { 0, 1, 3 };
static const ber_tlv_tag_t asn_DEF_CellInfoSI_RSCP_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_CellInfoSI_RSCP_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_CellInfoSI_RSCP_specs_1 = {
