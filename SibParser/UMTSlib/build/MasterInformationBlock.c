...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_7 = {
	sizeof(struct MasterInformationBlock__v690NonCriticalExtensions__nonCriticalExtensions),
	offsetof(struct MasterInformationBlock__v690NonCriticalExtensions__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_v690NonCriticalExtensions_5[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct MasterInformationBlock__v690NonCriticalExtensions, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
