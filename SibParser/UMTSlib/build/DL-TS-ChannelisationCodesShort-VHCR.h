...
extern asn_SEQUENCE_specifics_t asn_SPC_DL_TS_ChannelisationCodesShort_VHCR_specs_1;
extern asn_TYPE_member_t asn_MBR_DL_TS_ChannelisationCodesShort_VHCR_1[1];
