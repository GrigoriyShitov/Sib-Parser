...
asn_TYPE_member_t asn_MBR_HCS_CellReselectInformation_RSCP_1[] = {
...
static const ber_tlv_tag_t asn_DEF_HCS_CellReselectInformation_RSCP_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_HCS_CellReselectInformation_RSCP_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* penaltyTime */
};
asn_SEQUENCE_specifics_t asn_SPC_HCS_CellReselectInformation_RSCP_specs_1 = {
