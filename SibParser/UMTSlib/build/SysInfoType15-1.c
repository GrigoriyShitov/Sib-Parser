...
static asn_SEQUENCE_specifics_t asn_SPC_nonCriticalExtensions_specs_3 = {
	sizeof(struct SysInfoType15_1__nonCriticalExtensions),
	offsetof(struct SysInfoType15_1__nonCriticalExtensions, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_SysInfoType15_1_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SysInfoType15_1, nonCriticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static const int asn_MAP_SysInfoType15_1_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_SysInfoType15_1_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_SysInfoType15_1_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* ue-positioning-GPS-DGPS-Corrections */
