...
static asn_oer_constraints_t asn_OER_type_USCH_TransportChannelsInfo_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..32)) */};
asn_per_constraints_t asn_PER_type_USCH_TransportChannelsInfo_constr_1 CC_NOTUSED = {
...
static const asn_TYPE_tag2member_t asn_MAP_Member_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* usch-TransportChannelIdentity */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* usch-TFS */
};
...
asn_TYPE_member_t asn_MBR_USCH_TransportChannelsInfo_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_Member_2,
...
static const ber_tlv_tag_t asn_DEF_USCH_TransportChannelsInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
asn_SET_OF_specifics_t asn_SPC_USCH_TransportChannelsInfo_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_USCH_TransportChannelsInfo = {
	...
	sizeof(asn_DEF_USCH_TransportChannelsInfo_tags_1)
		/sizeof(asn_DEF_USCH_TransportChannelsInfo_tags_1[0]), /* 1 */
	{ &asn_OER_type_USCH_TransportChannelsInfo_constr_1, &asn_PER_type_USCH_TransportChannelsInfo_constr_1, SEQUENCE_OF_constraint },
